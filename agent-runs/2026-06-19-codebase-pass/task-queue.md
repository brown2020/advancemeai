...
| T-003 | P1 | Findings | Open | `agent-runs/2026-06-19-codebase-pass/03-findings-backlog.md`, `task-queue.md` | Findings have evidence, severity, effort, risk, and verification | 0/1 | Backlog prioritized and first fix task is clear | Audit code paths and dependency findings after baseline |
