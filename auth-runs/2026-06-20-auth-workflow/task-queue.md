...
| AUTH-003 | P1 | Done | Implementation | `src/lib/auth.tsx`, auth UI, session route, nav/footer | Firebase-native gaps hardened, including password visibility toggles | Targeted tests + lint/build/test | 2/3 | Hardening complete or external Firebase setup blocker recorded | Commit and push |
